...
class SofiaTableViewController: UITableViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        RequestManager.fetchData(latitude: "42.70", longitude: "23.32")
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "sofiaCellIdentifier", for: indexPath)
        
		switch indexPath.section {
        case 0:
            cell.textLabel?.text = "Sofia"
